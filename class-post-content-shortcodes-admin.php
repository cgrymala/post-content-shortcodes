	...
	class post_content_shortcodes_admin extends post_content_shortcodes {
		...
		function admin_menu() {
			...
			elseif( $this->is_plugin_active_for_network() )
				add_submenu_page( 'settings.php', __( 'Post Content Shortcodes Settings' ), __( 'Post Content Shortcodes' ), 'manage_network_plugins', $this->settings_page, array( $this, 'admin_page' ) );
			else
...
?>
<p>This page allows you to tweak various elements within the Post Content Shortcodes plugin.</p>
<?php
		}
