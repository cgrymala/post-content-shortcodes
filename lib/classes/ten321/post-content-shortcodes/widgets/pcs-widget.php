			...
			public function common_fields( $instance = array() ) {
				...
				if ( array_key_exists( 'view_template', $this->defaults ) ) {
					...
					if ( is_array( $templates ) && ! empty( $templates ) && ! is_wp_error( $templates ) ) {
						...
						?>
                        <p>
                            <label for="<?php echo $this->get_field_id( 'view_template' ) ?>"><?php _e( 'Views Content Template', 'post-content-shortcodes' ) ?></label>
                            <select name="<?php echo $this->get_field_name( 'view_template' ) ?>"
                                    id="<?php echo $this->get_field_id( 'view_template' ) ?>">
				...
				?>
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'show_image' ) ?>"
                ...
                <fieldset>
                    ...
                    <input class="tiny-text" type="number" value="<?php echo intval( $instance['image_width'] ) ?>"
                           name="<?php echo $this->get_field_name( 'image_width' ) ?>"
                           id="<?php echo $this->get_field_id( 'image_width' ) ?>"/><?php _e( 'px' ) ?>
					<?php _e( ' x ', 'post-content-shortcodes' ) ?>
                    <label for="<?php echo $this->get_field_id( 'image_height' ) ?>">
						<?php _e( 'Height: ', 'post-content-shortcodes' ) ?>
                    </label>
                    <input class="tiny-text" type="number" value="<?php echo intval( $instance['image_height'] ) ?>"
                           name="<?php echo $this->get_field_name( 'image_height' ) ?>"
                           id="<?php echo $this->get_field_id( 'image_height' ) ?>"/><?php _e( 'px' ) ?>
                </fieldset>
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'show_comments' ) ?>"
                           id="<?php echo $this->get_field_id( 'show_comments' ) ?>"
                           value="1"<?php checked( $instance['show_comments'] ) ?>/>
                ...
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'show_excerpt' ) ?>"
                           id="<?php echo $this->get_field_id( 'show_excerpt' ) ?>"
                           value="1"<?php checked( $instance['show_excerpt'] ) ?>/>
                ...
                <p>
                    ...
                    <input type="number" value="<?php echo $instance['excerpt_length'] ?>"
                           name="<?php echo $this->get_field_name( 'excerpt_length' ) ?>"
                           id="<?php echo $this->get_field_id( 'excerpt_length' ) ?>"/><br/>
                    <em>
						<?php _e( 'Leave set to 0 if you do not want the excerpts limited.', 'post-content-shortcodes' ) ?>
                    </em>
                </p>
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'read_more' ) ?>"
                           id="<?php echo $this->get_field_id( 'read_more' ) ?>"
                           value="1"<?php checked( $instance['read_more'] ) ?>/>
                    <label for="<?php echo $this->get_field_id( 'read_more' ) ?>">
						<?php _e( 'Include a "Read more" link?', 'post-content-shortcodes' ) ?>
                    </label>
                </p>
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'shortcodes' ) ?>"
                           id="<?php echo $this->get_field_id( 'shortcodes' ) ?>"
                           value="1"<?php checked( $instance['shortcodes'] ) ?>/>
                    <label for="<?php echo $this->get_field_id( 'shortcodes' ) ?>">
						<?php _e( 'Allow shortcodes inside of the excerpt?', 'post-content-shortcodes' ) ?>
                    </label>
                </p>
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'strip_html' ) ?>"
                           id="<?php echo $this->get_field_id( 'strip_html' ) ?>"
                           value="1"<?php checked( $instance['strip_html'] ) ?>/>
                ...
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'show_author' ) ?>"
                           id="<?php echo $this->get_field_id( 'show_author' ) ?>"
                           value="1"<?php checked( $instance['show_author'] ) ?>/>
                    <label for="<?php echo $this->get_field_id( 'show_author' ) ?>">
						<?php _e( 'Display the author\'s name?', 'post-content-shortcodes' ) ?>
                    </label>
                </p>
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'show_date' ) ?>"
				...
				?>
                <p>
                    <input type="checkbox" name="<?php echo $this->get_field_name( 'link_image' ) ?>"
                           id="<?php echo $this->get_field_id( 'link_image' ) ?>"
                           value="1"<?php checked( $instance['link_image'] ) ?>/>
