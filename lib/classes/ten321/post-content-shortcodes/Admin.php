...
namespace Ten321\Post_Content_Shortcodes {
	...
	if ( ! class_exists( 'Admin' ) ) {
			class Admin extends Base {
				 ...
				 */
				public string $settings_page = 'post-content-shortcodes';
				/**
				 * @since  0.1
				 * @access public
				 * @var    string the handle for the admin settings section
				 */
				public string $settings_section = 'post-content-shortcodes';
				 ...
				 *@since  0.1
				 */
				protected function _set_options( $opt ): bool|array {
					if ( ! is_multisite() ) {
						return false;
					}
	...
	<?php
				 ...
				 *@since  0.1
				 */
				function settings_field( array $args ) {
	?>
	...
	<?php
				 ...
				 *@since  0.1
				 */
				protected function options_updated_message( string $msg ) {
	?>
