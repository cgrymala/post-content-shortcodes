...
namespace Ten321\Post_Content_Shortcodes\Blocks {
	...
	use Ten321\Post_Content_Shortcodes\Helpers;
	...
	if ( ! class_exists( 'PCS_Block' ) ) {
		abstract class PCS_Block {
			...
			public function __construct() {
				Helpers::log( 'Entered the PCS_Block __construct() method' );
			...
			public function register_block_type() {
				...
				Helpers::log( 'Attributes Array looks like: ' );
				Helpers::log( print_r( $atts, true ) );
				...
				Helpers::log( 'Preparing to register a new Block' );
				Helpers::log( print_r( $args, true ) );
			...
			public function localize_script( string $handle ) {
				$script = [
					'pluginDirPath' => Helpers::plugin_dir_path(),
					'pluginDirUrl'  => Helpers::plugin_dir_url(),
